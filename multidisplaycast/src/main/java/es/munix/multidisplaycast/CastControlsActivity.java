...
public class CastControlsActivity extends AppCompatActivity implements CastListener, PlayStatusListener, SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    private void setViews() {
        ...
        subtitleTextView = findViewById(R.id.movie_subtitle);
        ...
        volumeBarControl = findViewById(R.id.volumeControl);
        streamSeekBar = findViewById(R.id.stream_seek_bar);
    ...
    private void paintInterface() {
        ...
        Glide.with(this)
                .load(createImgUrl(mediaObject.getImage()))
                .apply(new RequestOptions().signature(new ObjectKey(mediaObject.getTitle()+mediaObject.getSubtitle())))
    ...
    public void onPlayStatusChanged(int playStatus) {
        switch (playStatus) {
            ...
            case STATUS_RESUME_PAUSE:
                play.setImageResource(R.drawable.ic_mc_pause);
                break;
            ...
            case STATUS_PAUSED:
                play.setImageResource(R.drawable.ic_mc_play);
                break;
    ...
    public void onPositionChanged(long currentPosition) {
        if (!isSeeking && streamPositionTextView != null && streamSeekBar != null) {
